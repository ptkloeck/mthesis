...
def main():
    ...
    parser.add_argument("--file", type=str, 
                    help="the input file")
    parser.add_argument("--extract_features", type=int, nargs='+',
                    help="list of feature categories to extract. possible categories are: 1, 2, ..., 9")
    parser.add_argument("--classify_features", type=int, nargs='+',
    ...
    if args.classify_features is not None:
        ...
        for feature_category_id in classify_features:
            classify_feature_categories.add(feature_extraction.FeatureCategory(feature_category_id)) 
