...
def train_classifiers_relations(ant_syn, feature_categories):
    ...
    for pos in util.POS:
        train_classifier_pos_relations(pos, ant_syn, feature_categories)

def train_classifier_pos_relations(pos, ant_syn, feature_categories):
...
def feature_matrix(df, feature_categories):
    ...
    col_heads = []
    for feature_category in feature_categories:
        col_heads.extend(feature_extraction.make_feature_extractor(feature_category).feature_col_headers())
